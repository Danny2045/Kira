...
TARGET_PAIRS = [
    {
        ...
        "human_target": "HDAC8",
        "parasite_uniprot": "C1LV40",  # SmHDAC8
    ...
    },
    {
        ...
        "human_target": "DHODH",
        "parasite_uniprot": "C1L5Z2",      # SmDHODH
    ...
    },
    {
        ...
        "parasite_uniprot": "Q8WQ44",      # T. brucei cathepsin B
    ...
    },
    {
        ...
        "human_target": "DHFR",
        "parasite_uniprot": "P07382",      # L. major DHFR-TS
        "human_uniprot": "P00374",          # Human DHFR
        "selectivity_source": "leish",
    },
]
...
def build_selectivity_classifier(selectivity_df, pair_df, embeddings, sequences):
    ...
    # Build SMILES lookup from all activity files
    all_smiles = {}
    for path in [

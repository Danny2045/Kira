#!/bin/bash
# Run this from ~/kira with: bash create_script02.sh
# It creates 02_query_chembl.py for you.

cat > 02_query_chembl.py << 'PYTHONSCRIPT'
"""
...
echo "Created 02_query_chembl.py successfully."
echo "Now run: python 02_query_chembl.py"
